...
contract ThreeThree is ERC20Permit, Ownable {
    ...
    constructor() ERC20("ThreeThree", "THREETHREE", 9) ERC20Permit() {
    ...
    /**
        @notice increases ThreeThree supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess ThreeThree
